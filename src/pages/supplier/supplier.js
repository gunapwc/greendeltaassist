    ...
    <div className="partner">
      <div className="container">
        <PriTitle
          ...
          details={
            "Kindly fill the form below to share your information with our buyers."
          }
        />
        <PriTitle details={"General Information"} />
        ...
        <div className="form_group">
          <div className="exand_width">
            ...
            <input
              type={"text"}
              placeholder="Operation in other Country(if yes,please specify)"
              name=""
            />
