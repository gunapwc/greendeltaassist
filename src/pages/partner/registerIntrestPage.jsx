    ...
    return (
        <div className="container register">
            <form onSubmit={(e) => { handleClick(e) }} de>
                ...
                <br />
                <br />
                <h1>Franchisee Evaluation </h1>
                <br />
                <p><b>Privacy Policy:</b> All information provided is kept confidential & will not be disclosed except for purposes of verification.</p>
                <br />
                ...
                <h2>Applicant's Franchise Plan</h2>
...
export default RegisterIntrestPage;